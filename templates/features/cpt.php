 ...
 *
 * TODO add nonce verification & Remove Globals
 *
 * @package RanPlugin
 */
	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane <?php echo ! isset( $_POST['edit_post'] ) ? 'active' : ''; ?>">
			...
			foreach ( $options as $option ) {
				...
				settings_fields( 'ran_plugin_cpt_settings' );
		...
		<div id="tab-3" class="tab-pane">
			...
			<?php foreach ( $options as $option ) { ?>
				...
				<h3><?php echo esc_html( $option['singular_name'] ); ?></h3>
...
function custom_post_type() {
	...
	$labels = array(
		...
		'attributes'            => __( 'Item Assets', 'text_domain' ),
